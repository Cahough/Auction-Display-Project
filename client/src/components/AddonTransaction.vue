...
.addon_grid-container {
  display: grid;
  grid-template-columns: 1fr 1fr 1fr 1fr 1fr;
  grid-template-rows: 1fr;
  grid-template-areas: "sale_form sale_view sale_view sale_view sale_view"; }

.sale_form { grid-area: sale_form; }

.sale_view {
  display: grid;
  grid-template-columns: 1fr 1fr 1fr 1fr;
  grid-template-rows: 1fr;
  grid-template-areas: "current_exhibitor current_buyers current_addons current_addons2";
  grid-area: sale_view; }
